...
- (void)drawLines {
    ENChartType top = KlineStyle.shared.topChartType;
    switch (top) {
        case ENChartTypeMA:
            [self MA];
            break;
    ...
    ENChartType bottom = KlineStyle.shared.bottomChartType;
    switch (bottom) {
...
- (void)RSI {
	...
	CAShapeLayer *rsi = [self drawLineWithPoints:_data.rsi6 lineWidth:1 lineColor:KlineStyle.shared.color_1];
	[self addSublayer:rsi];
	CAShapeLayer *rsi12 = [self drawLineWithPoints:_data.rsi12 lineWidth:1 lineColor:KlineStyle.shared.color_2];
	[self addSublayer:rsi12];
	CAShapeLayer *rsi24 = [self drawLineWithPoints:_data.rsi24 lineWidth:1 lineColor:KlineStyle.shared.color_3];
